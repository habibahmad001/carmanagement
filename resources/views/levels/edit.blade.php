...
<div class="add-new-form edit-current-data">
  ...
  <form method="POST" id="category_form" action="{!! URL::to("/level-update") !!}" accept-charset="UTF-8" onSubmit="return validate('edit-');">
    ...
    <div class="form-height-control">
      ...
      <div class="form-line">
       ...
       <div class="form-line">
        <input type="text" name="level_name" id="edit-level_name" placeholder="Level Name">
      </div>
